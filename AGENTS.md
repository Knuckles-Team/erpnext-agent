...
<!-- CONCEPT:EN-OS.governance.erpn-2 -->
<!-- CONCEPT:EN-OS.identity.erpn -->
...
|------------|------|-------------|
| `CONCEPT:EN-OS.governance.erpn` | Core API Client Operations | Dynamic API facade client integration |
| `CONCEPT:EN-OS.governance.erpn-2` | FastMCP Tools Execution | FastMCP tool registration and stdio handling |
| `CONCEPT:EN-OS.identity.erpn` | Identity & Gateway Security | Credential validation and SSL verification |
