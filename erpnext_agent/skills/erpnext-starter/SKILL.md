---
name: erpnext-starter
description: >-
  Erpnext API + MCP Server + A2A Server Use when working with Erpnext via this package's MCP
...
license: MIT
tags: [erpnext-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Erpnext Starter Skill

Starter skill for the **Erpnext** package. Use the `mcp-client` universal skill
